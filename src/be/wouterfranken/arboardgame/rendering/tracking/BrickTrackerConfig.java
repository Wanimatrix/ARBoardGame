	...
	private static ConfigurationItem<?>[] INITIAL_CONFIG_ITEMS = 
		{
			...
			new ConfigurationItem<Long>("ORI", "NECESS_ORIENTATIONS", "Necessary orientations", 20l),
			new ConfigurationItem<Double>("REM_THR", "OVERLAP_REMOVAL_THRESHOLD", "Overlap removal threshold", 0.70),
