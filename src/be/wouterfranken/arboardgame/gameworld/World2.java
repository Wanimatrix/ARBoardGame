...
public class World2 {
	private static final String TAG = World2.class.getSimpleName();
...
//	private Object brickLock = new Object();
	...
	private LegoBrickTracker brickTracker;
	private CameraPoseTracker cameraPose;
	
	public World2(LegoBrickTracker brickTracker, CameraPoseTracker cameraPose) {
...
//	}
	...
	public Mat getBrickThreshold() {
		return this.brickTracker.getThreshold();
	}
	
	public CameraPoseTracker getCameraPoseTracker() {
		return cameraPose;
	}
